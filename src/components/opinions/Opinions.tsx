...
export default function Opinions() {
  return (
    <div className="flex flex-col gap-10 md:gap-12 lg:gap-16 2xl:gap-[69px] desktop:gap-24 ultra:gap-32">
      ...
      <div className="mb-[200px] rounded-md flex flex-col antialiased bg-white dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
        <InfiniteMovingCards
          items={testimonials}
          direction="right"
          speed="slow"
